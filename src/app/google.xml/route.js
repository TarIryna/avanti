import { getStyle, getDescription, getVendor, getName,getGoogleGender, escapeXML, getMaterialTop, getColorById, getColorNameById } from "@/data/getData";
  ...
  ?.flatMap((p) => {
    ...
    return p.sizes.map((s) => {
      ...
      <item>
        ...
        <g:color>${escapeXML(getColorNameById(p.color, "ukr"))}</g:color>
